# Generated by Django 6.0.5 on 2026-05-13 03:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='clients.role')),
            ],
            options={
                'db_table': 'users',
                'ordering': ['username'],
